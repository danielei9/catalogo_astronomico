...
public class CatalogoAstronomicoTest {
    ...
    public void toString_esCorrecto() {
        ...
        c.anade(g1);
        c.anade(g2);
        assertEquals("[objeto-Astro {nombre: galaxia, tipo: Galaxia, brillo: 0.0, distancia: 2.2}, objeto-Astro {nombre: galaxia1, tipo: Galaxia, brillo: 1.0, distancia: 3.2}, objeto-Astro {nombre: galaxia2, tipo: Galaxia, brillo: 2.0, distancia: 4.2}]"
                , c.toString());
    }
